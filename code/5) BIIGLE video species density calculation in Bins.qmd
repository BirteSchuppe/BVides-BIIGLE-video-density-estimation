...
```{r}
bins_df %>% 
  write_csv(paste0("../Output/",bin_size,"mbins_species_abundances_annotations_3Dsmoothed.csv"))
```
...
bins_df_density %>% 
  write_csv(paste0(wd,"/Output/",bin_size,"mbins_species_densities_annotations_3Dsmoothed.csv"))
...
total_df_density  %>% 
  write_csv(paste0(wd,"/Output/","species_densities_annotations_3Dsmoothed.csv")) 
